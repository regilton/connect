...
if (($nome == "") or ($telefone == "") or ($empresa == "")) {
  ...
  try {
    ...
    $mailClient->Subject = ":: CONNECT SISTEMAS - PEDIDO DE LIGA&Ccedil;&Atilde;O ::";
    $mailAdmin->Subject = ':: PEDIDO DE LIGA&Ccedil;&Atilde;O CLIENTE ::';
...
<p>Ficamos felizes com o seu interesse em falar conosco sobre um de nossos sistemas.<br>
Iremos providenciar o contato que voc&ecirc; solicitou, no telefone(" . $telefone . ") infomado no formulário.<br><br>  
Al&eacute;m do sistema que voc&ecirc; deseja adquirir (" . utf8_decode($segmento) . ") nossa equipe tamb&eacute;m esta pronta para falar sobre outros segmentos como:</p>
<ul>
<li>SUPERMERCADOS</li>
<li>MERCADINHOS</li>
<li>PADARIA</li>
...
<p>Caso n&atilde;o possa esperar pela liga&ccedil;&atilde;o e ache necess&aacute;rio deixe uma mensagem em nosso whatsapp: <a href=\"https://api.whatsapp.com/send?phone=5585997115400&text=Ol%C3%A1%2C%20eu%20acabei%20de%20receber%20um%20email%20de%20com%20o%20orcamento\">85 9 9711 5400</a></p>
<p>-----------------------------------------------------</p>
...
<p>Fique atento, o(a) cliente: " . utf8_decode($nome) . ",  deseja um liga&ccedil;&atilde;o para adquirir um sistema para o segmento: (<strong>" . utf8_decode($segmento) . "</strong>).</p>
<p>----------- <strong>DADOS DO CLIENTE</strong> -----------</p>
<p>Nome: " . utf8_decode($nome) . "</p>
<p>Telefone: " . $telefone . "</p>
<p>Email: " . $email . "</p>
<p>Empresa: " . utf8_decode($empresa) . "</p>
<p>CNPJ: " . utf8_decode($segmento) . "</p>
...
<p><a href=\"https://wa.me/55" . $telefone . "?text=Ol%C3%A1+%F0%9F%91%8B+cliente%2C+somos+da+Connect+Sistemas+e+gostar%C3%ADamos+de+falar+com+voc%C3%AA\">" . $telefone . "</a></p>
<br><br>
